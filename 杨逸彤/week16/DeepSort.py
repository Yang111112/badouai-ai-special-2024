...
# 加载YOLO模型用于目标检测
yolo_model = YOLO('E:/practice/badou/class/2024ai/[16]目标跟踪&姿态检测/代码/deepsort简单版/yolov5s.pt')
...
# 打开视频文件
cap = cv2.VideoCapture('E:/practice/badou/class/2024ai/[16]目标跟踪&姿态检测/代码/deepsort简单版/test5.mp4')
tracker = DeepSort()
